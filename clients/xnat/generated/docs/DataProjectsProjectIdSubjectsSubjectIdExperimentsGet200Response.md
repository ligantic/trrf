...
------------ | ------------- | ------------- | -------------
**result_set** | [**DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200ResponseResultSet**](DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200ResponseResultSet.md) |  | [optional] 
...
json = "{}"
# create an instance of DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200Response from a JSON string
data_projects_project_id_subjects_subject_id_experiments_get200_response_instance = DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200Response.from_json(json)
# print the JSON string representation of the object
print(DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200Response.to_json())
