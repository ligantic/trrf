...
**series_description** | **str** | series description | [optional] 
**uri** | **str** | relative URI to this scan | [optional] 
...
json = "{}"
# create an instance of DataExperimentsExperimentIdScansGet200ResponseResultSetResultInner from a JSON string
data_experiments_experiment_id_scans_get200_response_result_set_result_inner_instance = DataExperimentsExperimentIdScansGet200ResponseResultSetResultInner.from_json(json)
# print the JSON string representation of the object
print(DataExperimentsExperimentIdScansGet200ResponseResultSetResultInner.to_json())
