...
**label** | **str** | experiment label | [optional] 
**insert_date** | **str** | insert date | [optional] 
**uri** | **str** | relative URI to this experiment | [optional] 
...
json = "{}"
# create an instance of DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200ResponseResultSetResultInner from a JSON string
data_projects_project_id_subjects_subject_id_experiments_get200_response_result_set_result_inner_instance = DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200ResponseResultSetResultInner.from_json(json)
# print the JSON string representation of the object
print(DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200ResponseResultSetResultInner.to_json())
