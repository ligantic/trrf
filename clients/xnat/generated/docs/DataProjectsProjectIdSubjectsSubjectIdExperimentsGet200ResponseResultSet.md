...
------------ | ------------- | ------------- | -------------
**result** | [**List[DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200ResponseResultSetResultInner]**](DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200ResponseResultSetResultInner.md) |  | [optional] 
...
json = "{}"
# create an instance of DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200ResponseResultSet from a JSON string
data_projects_project_id_subjects_subject_id_experiments_get200_response_result_set_instance = DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200ResponseResultSet.from_json(json)
# print the JSON string representation of the object
print(DataProjectsProjectIdSubjectsSubjectIdExperimentsGet200ResponseResultSet.to_json())
