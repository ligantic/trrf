...
------------ | ------------- | ------------- | -------------
**result_set** | [**DataExperimentsExperimentIdScansGet200ResponseResultSet**](DataExperimentsExperimentIdScansGet200ResponseResultSet.md) |  | [optional] 
...
json = "{}"
# create an instance of DataExperimentsExperimentIdScansGet200Response from a JSON string
data_experiments_experiment_id_scans_get200_response_instance = DataExperimentsExperimentIdScansGet200Response.from_json(json)
# print the JSON string representation of the object
print(DataExperimentsExperimentIdScansGet200Response.to_json())
