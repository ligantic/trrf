...
from rdrf.helpers.transform_cd_dict import (
    get_cd_form,
    get_section,
    transform_cd_dict,
)
...
class TestFormPermissions(RDRFTestCase):
    ...
    def test_user_in_wrong_group_cant_view_form(self):
        ...
        curator_group, created = Group.objects.get_or_create(
...
class ExporterTestCase(RDRFTestCase):
    ...
    def test_export_registry(self):
        ...
        set__of_cdes_in_forms = self._get_cde_codes_from_registry_export_data(
            data
        )
...
class FormTestCase(RDRFTestCase):
    ...
    def setUp(self):
        ...
        self.working_group, created = WorkingGroup.objects.get_or_create(
            name="WA"
        )
    ...
    def create_section(
        ...
        section, created = Section.objects.get_or_create(
            code=code, defaults={"abbreviated_name": code}
        )
...
class LongitudinalTestCase(FormTestCase):
    def test_simple_form(self):
        ...
        self.assertGreater(
            len(snapshots), 0, "History should be filled in on save"
        )
...
class TimeStripperTestCase(TestCase):
    ...
    def test_timestripper(self):
        ...
        fh_index_before = self.data_with_date_cdes["forms"][0]["sections"][0][
            "cdes"
        ][0]["value"]
        ...
        fh_index_after = self.data_with_date_cdes["forms"][0]["sections"][0][
            "cdes"
        ][0]["value"]
        ...
        value1 = self.data_with_date_cdes["forms"][0]["sections"][0]["cdes"][1][
            "value"
        ]
        self.assertTrue(
        ...
        value2 = self.data_with_date_cdes["forms"][0]["sections"][0]["cdes"][2][
            "value"
        ]
        self.assertTrue(
    ...
    def test_history_munging(self):
        ...
        self.assertTrue(
            ...
            "Expected: %s, Actual: %s"
            % (expected_dates, ts.converted_date_cdes),
        )
