...
class ReportGeneratorTestCase(TestCase):
    ...
    def test_graphql_query_minimal_data(self):
        ...
        self.assertEqual(
            {"filterArgs": {"consentQuestions": [], "workingGroups": []}},
            variables,
        )
    ...
    def test_graphql_query_pagination(self):
        ...
        variables, actual_query = report._get_graphql_query(
            self._request(), limit=15, offset=30
        )
        expected = """
            query AllPatientsQuery($filterArgs: PatientFilterType) {
                ang {
    ...
    def test_graphql_query_pivot_fields(self):
        ...
        cs1 = ConsentSection.objects.create(
            registry=reg_ang, code="cs1", section_label="cs1"
        )
        ConsentQuestion.objects.create(
            section=cs1, code="angConsent1", position=1
        )
        ConsentQuestion.objects.create(
            section=cs1, code="angConsent2", position=2
        )
        ConsentQuestion.objects.create(
            section=cs1, code="angConsent3", position=3
        )
        ConsentQuestion.objects.create(
            section=cs1, code="angConsent4", position=4
        )
        ...
        report_design.reportdemographicfield_set.create(
            model="consents", field="answer", sort_order=0
        )
        report_design.reportdemographicfield_set.create(
            model="consents", field="firstSave", sort_order=0
        )
        report = ReportBuilder(report_design)
  ...
  ang {
    ...
    def test_graphql_query_max_data(self):
        ...
        CommonDataElement.objects.create(
            code="6StartsWithNumber",
            name="Field starts with number",
            abbreviated_name="Number field",
        )
        CommonDataElement.objects.create(
            code="TimeToBed", name="Time to bed", abbreviated_name="Time"
        )
        CommonDataElement.objects.create(
            code="TimeAwake",
            name="Time Awake in the morning",
            abbreviated_name="Time",
        )
        CommonDataElement.objects.create(
            code="DayOfWeek", name="Day of Week", abbreviated_name="Day"
        )
        Section.objects.create(
            code="SleepSection",
            elements="6StartsWithNumber,TimeToBed,TimeAwake,DayOfWeek",
            display_name="Sleep",
            abbreviated_name="SleepSEC",
        )
        form = RegistryForm.objects.create(
            name="SleepForm",
            sections="SleepSection",
            abbreviated_name="SleepFRM",
            registry=reg_ang,
        )
        cfg_sleep = ContextFormGroup.objects.create(
            registry=reg_ang,
            code="Sleep",
            name="Sleep Group",
        ...
        CommonDataElement.objects.create(
            code="ResideNewborn", name="x", abbreviated_name="Newborn"
        )
        CommonDataElement.objects.create(
            code="ResideInfancy", name="x", abbreviated_name="Infancy"
        )
        Section.objects.create(
            code="ANGNewbornInfancyReside",
            elements="ResideNewborn,ResideInfancy",
            display_name="Reside Newborn/Infancy",
            abbreviated_name="NewInfReside",
        )
        form = RegistryForm.objects.create(
            name="NewbornAndInfancyHistory",
            sections="ANGNewbornInfancyReside",
            abbreviated_name="NewInfForm",
            registry=reg_ang,
        )
        cfg_history = ContextFormGroup.objects.create(
            registry=reg_ang,
            code="History",
        ...
        wg1 = WorkingGroup.objects.create(
            id=8, registry=reg_ang, name="Working Group 1"
        )
        wg2 = WorkingGroup.objects.create(
            id=9, registry=reg_ang, name="Working Group 2"
        )

        report_design = ReportDesign.objects.create(registry=reg_ang)
        report_design.reportdemographicfield_set.create(
            model="patient", field="familyName", sort_order=0
        )
        report_design.reportdemographicfield_set.create(
            model="patient", field="givenNames", sort_order=1
        )
        report_design.reportdemographicfield_set.create(
            model="patientaddressSet", field="state", sort_order=2
        )
        report_design.reportdemographicfield_set.create(
            model="patientaddressSet", field="country", sort_order=3
        )
        report_design.reportdemographicfield_set.create(
            model="workingGroups", field="name", sort_order=4
        )

        report_design.reportclinicaldatafield_set.create(
            context_form_group=cfg_history,
        ...
        report_design.reportclinicaldatafield_set.create(
            context_form_group=cfg_sleep,
            cde_key="SleepForm____SleepSection____DayOfWeek",
        )
        report_design.reportclinicaldatafield_set.create(
            context_form_group=cfg_sleep,
            cde_key="SleepForm____SleepSection____TimeToBed",
        )
        report_design.reportclinicaldatafield_set.create(
            context_form_group=cfg_sleep,
            cde_key="SleepForm____SleepSection____TimeAwake",
        )
        report_design.reportclinicaldatafield_set.create(
            context_form_group=cfg_sleep,
            cde_key="SleepForm____SleepSection____6StartsWithNumber",
        )
  ...
  ang {
    ...
    def test_graphql_query_include_form_timestamps(self):
        ...
        report_design = ReportDesign.objects.create(
            registry=reg_ang, cde_include_form_timestamp=True
        )
  ...
  ang {
    ...
    def test_pre_export_validation(self):
        ...
        CommonDataElement.objects.create(
            code="BestDay", name="Day of Week", abbreviated_name="Best Day"
        )
        Section.objects.create(
            code="SleepSection",
            elements="TimeToBed,TimeAwake,DayOfWeek,BestDay",
            display_name="Sleep",
            abbreviated_name="SleepSEC",
        )
        form = RegistryForm.objects.create(
        ...
        report_design.reportclinicaldatafield_set.create(
            context_form_group=cfg,
            cde_key="SleepForm____SleepSection____BestDay",
        )
        ...
        self.assertEqual(
            ["Sleep Group_Sleep Form_Sleep_Day of Week"],
            [*errors["duplicate_headers"].keys()],
        )
        ...
        self.assertFalse(is_valid)
        self.assertEqual(
            ["SleepCFG_SleepFRM_SleepSEC_Time"],
            [*errors["duplicate_headers"].keys()],
        )
    ...
    def test_get_demographic_headers(self):
        def setup_test_data():
            ...
            self.registry_with_no_consent_questions = Registry.objects.create(
                code="REG2"
            )
            ...
            cs1 = ConsentSection.objects.create(
                ...
                code="CS1",
                section_label="Consent Section 1",
            )
            ...
            p1 = Patient.objects.create(
                consent=True, date_of_birth=datetime(1970, 1, 1)
            )
            p1.rdrf_registry.set(
                [self.registry, self.registry_with_no_consent_questions]
            )
        ...
        report_design.reportdemographicfield_set.create(
            sort_order=1, model="patient", field="id"
        )
        report_design.reportdemographicfield_set.create(
            sort_order=2, model="patient", field="familyName"
        )
        report_design.reportdemographicfield_set.create(
            sort_order=3,
            model="patient",
        ...
        report_design.reportdemographicfield_set.create(
            sort_order=4,
            model="patientaddressSet",
            field="addressType { type }",
        )
        report_design.reportdemographicfield_set.create(
            sort_order=5, model="patientaddressSet", field="address"
        )
        report_design.reportdemographicfield_set.create(
            sort_order=6, model="patientaddressSet", field="suburb"
        )

        report_design.reportdemographicfield_set.create(
            sort_order=7, model="consents", field="answer"
        )
        report_design.reportdemographicfield_set.create(
            sort_order=8, model="consents", field="firstSave"
        )
        report_design.reportdemographicfield_set.create(
            sort_order=9, model="consents", field="lastUpdate"
        )
    ...
    def test_build_query_from_variants(self):
        ...
        self.assertEqual(
            report_builder._build_query_from_variants([], fields), []
        )
        self.assertEqual(
            report_builder._build_query_from_variants([[], []], fields), []
        )
        ...
        self.assertEqual(
            report_builder._build_query_from_variants(
                ["item1", "item2"], fields
            ),
        ...
        self.assertEqual(
            report_builder._build_query_from_variants(
                [["groupA", "item1"], ["groupA", "item2"]], fields
            ),
        ...
        self.assertEqual(
            report_builder._build_query_from_variants(
                [["groupA", "item1"], ["groupA", "item2"], ["groupB", "item3"]],
                fields,
            ),
            [
                "groupA { item1 { answer } item2 { answer } }",
        ...
        self.assertEqual(
            report_builder._build_query_from_variants(
                [["groupA", "item1"], ["groupB", "item3"], ["groupA", "item2"]],
                fields,
            ),
            [
                "groupA { item1 { answer } item2 { answer } }",
        ...
        self.assertEqual(
            ...
            [
                "groupA { subA { item1 { answer } item2 { answer } } subC { item4 { answer } } }",
                "groupB { subB { item3 { answer } } }",
            ],
        )
